 ...
 * 
 */
package Presentacion.Proveedores.VincularMarca;
...
public class GUIVincularMarca extends JFrame implements ObservadorGUI {
	...
	public GUIVincularMarca() {
		super("Vincular Marca y Proveedor");
		initGUI();
	}
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(correcto) {
					try {
						...
						Controlador.getInstance().accion(Eventos.VINCULAR_MARCA, rel);
						dispose();
					}
					catch (Exception o) {
						MensajeGUI a = new MensajeGUI();
						a.showMessage("Algo fue mal..." + o.getMessage(), "Vincular Marca", true);
					}
