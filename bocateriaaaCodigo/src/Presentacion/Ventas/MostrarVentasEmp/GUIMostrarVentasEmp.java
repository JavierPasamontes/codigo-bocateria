package Presentacion.Ventas.MostrarVentasEmp;
...
public class GUIMostrarVentasEmp extends JFrame{
	...
	public void initGUI() {
		...
		JLabel idemp=new JLabel("ID del empleado: ");
		id=new JTextField(5);
		botonPanel.add(idemp);
		botonPanel.add(id);
	...
	public void actualizar (ArrayList<TVentas> ven){
		...
		for (int i = 0; i < ven.size(); i++) {
			...
			//for(int j=0;j<ven.get(i).getListaProductos().size();j++) {
